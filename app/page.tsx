  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 to-gray-900 flex items-center justify-center p-4">
      <motion.form
        ...
        className="w-full max-w-md bg-gray-900 rounded-2xl shadow-2xl overflow-hidden border border-gray-700"
      ...
      >
        ...
        <div className="px-8 py-4 bg-gray-900 border-t border-gray-700 flex justify-between items-center">
          <motion.button
            type="button"
            onClick={addField}
          ...
          <motion.button
            ...
            className={`px-6 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50 transition duration-200 ease-in-out ${
